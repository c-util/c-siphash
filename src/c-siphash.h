...
/**
 * Standalone SipHash24 Implementation in Standard ISO-C11
 *
 * This library provides a SipHash24 API, that is fully implemented in ISO-C11
 ...
 * piecemeal.
 *
 * A hash state is represented by the "CSipHash" structure, which should be
 * initialized with a unique seed before use.
 */
...
/**
 * struct CSipHash - SipHash24 state object
